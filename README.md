...
The browser-gated suite covers the 17-category feature matrix under `tests/fixtures/html_first`, including chapter combination, native feature rendering, morph/state metadata, localized fallback, runtime integrity, Bento API editing, serialization, and paired screenshots.
